...
| :--- | :--- | :--- |
| **Personalized Preparedness Plans** | Gemini model `gemini-2.5-flash` analyzes family size, housing type, and local weather to output custom MD plan. | [PlannerTab.tsx](file:///c:/Users/Dell/OneDrive/Desktop/My%20Chapters/Main%20challenge/monsoon-app/src/components/PlannerTab.tsx) |
